  ...
  return (
    <>
        ...
        <Flex bg="#F1F4FD" direction="column" align="center">
          <Flex pt={{ base: 100, sm: 120 }}>
            <Box className="mb-10 text-center font-nexon text-gray-800">
              <h2 className="text-40 font-light leading-70 md:text-60 md:leading-100">
                남들이 만드는
              </h2>
              <h2 className="text-60 font-bold leading-70 md:text-90 md:leading-100">
                나만의 위키
              </h2>
            </Box>
          </Flex>
      ...
      <div>
        <Box
          bg="#474D66"
          pt={{ base: 100, sm: 153, lg: 131 }}
          pb={{ base: 100, sm: 160, lg: 200 }}
        >
          <Box px={20} mx="auto" my={0} maw={924}>
            <Flex gap={{ base: 10, sm: 20, lg: 40 }}>
              <Flex
                ...
                w={{ base: "35.5vw", sm: "35.2vw", lg: 364 }}
                gap={10}
              >
                <Flex
                  direction="column"
                  gap={{ base: 10, sm: 20 }}
                  className="font-nexon"
                >
                  <strong className="text-10 text-green-200 md:text-20 xl:text-30">
                    WRITE
                  </strong>
                ...
                <Box
                  className="rounded-[20px] bg-green-200"
                  pr={{ base: "5.3vw", sm: "5.37vw", lg: "4.5vw" }}
                >
                  <Image
                    src={LandingImg_02}
                    alt="키보드 이미지"
        ...
        >
          ...
          <Flex justify="center">
            <Grid
              maw={1920}
              mx="-15.4vw"
              mt={{ base: 40, sm: 80, lg: 120 }}
              gutter={{ base: "2.7vw", sm: "2.7vw", lg: "3.6vw" }}
            >
              <Grid.Col span={2}>
                <Box
                  w="100%"
      ...
      <div>
        <Flex
          ...
          gap={40}
          align="center"
          py={{ base: 100, sm: 160, lg: 200 }}
        >
          <h2 className="font-nexon text-30 font-semibold text-white md:text-60">
            나만의 위키 만들어 보기
          </h2>
          <Button
            component={Link}
      ...
      <footer>
        <Box
          ...
          bg="#3B415B"
          className="px-[20px] text-white md:px-[80px]"
        >
          <Flex direction="column">
            <strong className="mb-1 text-10 md:text-16">
